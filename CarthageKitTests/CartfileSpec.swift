...
class CartfileSpec: QuickSpec {
	override func spec() {
		it("should parse a Cartfile") {
			...
			expect(depReactiveCocoa.project).to(equal(ProjectIdentifier.GitHub(Repository(owner: "ReactiveCocoa", name: "ReactiveCocoa"))))
			...
			expect(depMantle.project).to(equal(ProjectIdentifier.GitHub(Repository(owner: "Mantle", name: "Mantle"))))
			...
			expect(depLibextobjc.project).to(equal(ProjectIdentifier.GitHub(Repository(owner: "jspahrsummers", name: "libextobjc"))))
			...
			expect(depConfigs.project).to(equal(ProjectIdentifier.GitHub(Repository(owner: "jspahrsummers", name: "xcconfigs"))))

...
public final class Project {
	...
	public func buildCheckedOutDependenciesWithConfiguration(configuration: String, forPlatform platform: Platform?, canBuildSDK: SDKFilterCallback? = nil, sendWarning: (String -> Void)? = nil) -> SignalProducer<BuildSchemeProducer, CarthageError> {
		return loadResolvedCartfile()

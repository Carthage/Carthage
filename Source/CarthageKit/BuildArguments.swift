...
public struct BuildArguments {
	...
	public var arguments: [String] {
		...
		if let derivedDataPath = derivedDataPath, let standarizedPath = URL(fileURLWithPath: (derivedDataPath as NSString).stringByExpandingTildeInPath).standardizedFileURL.path where !derivedDataPath.isEmpty && !standarizedPath.isEmpty {

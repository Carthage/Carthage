...
class VersionFileSpec: QuickSpec {
	override func spec() {
		...
		func validate(file: VersionFile, matches: Bool, platform: Platform, commitish: String, xcodeVersion: String, md5s: [String: String], fileName: FileString = #file, line: UInt = #line) {
